        ...
        <div style={{display:"grid"}}>
            ...
            <div className={styles.container}>
                        <div className={styles.box}>
                            <Link to="/Market"><img style={{width:"30vh",height:"30vh"}} src="./images/temp.jpg" alt="Market"></img></Link>
                            <br/><br/>
                            <Link to="/Market" className={styles.homeBtn}>Market</Link>
                        </div>

                        <div className={styles.box}>
                            <Link to="/Manage"><img style={{width:"30vh",height:"30vh"}} src="./images/manage.png" alt="Manage"></img></Link>
                            <br/><br/>
                            <Link to="/Manage" className={styles.homeBtn}>Manage</Link>
                        </div>

                        <div className={styles.box}>
                            <Link to="/Create"><img style={{width:"30vh",height:"30vh"}} src="./images/create.png" alt="Create"></img></Link>
                            <br/><br/>
                            <Link to="/Create" className={styles.homeBtnC}>Create</Link>
                        </div>
            </div>
        </div>
    );
